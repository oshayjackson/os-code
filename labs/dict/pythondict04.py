...
def main():
    ...
    # dict.keys() returns all the keys in a "list like" structure
    print(switch.keys())

    # return all of the values in the dictionary
    print("Fifth test - .values()")
    # dict.values() returns all of the values in a "list like" structure
    print(switch.values())

    # remove a value from our dictionary using del
    # this just removes key/value pair and returns nothing
    del switch["vendor"]
    ...
    # removes this key and ALSO return the VALUE "1.2"
    ...
    # using the list()
    # this selects the 2nd position (3rd item) from the list
